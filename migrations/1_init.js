(function()
{
    ...
    var cmds = {
        ...
        make_postsTBL: 'CREATE TABLE `posts` (`author` TEXT, `permlink` TEXT, `title` TEXT, `status` TEXT, `latestPublishedTX` TEXT, `date` INTEGER, `scheduledDate` INTEGER, `tag1` TEXT, `tag2` TEXT, `tag3` TEXT, `tag4` TEXT, `tag5` TEXT, `featuredImg` TEXT, `warningMsg` TEXT, PRIMARY KEY(`author`,`permlink`));',
