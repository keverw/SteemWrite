(function()
{
    ...
    var cmds = {
        ...
        make_revisionsTBL: 'CREATE TABLE `revisions` (`revHash` TEXT, `contentHash` TEXT, `publishedTX` TEXT, `author` TEXT, `permlink` TEXT, `title` TEXT, `body` TEXT, `json_metadata` TEXT, `localDate` INTEGER, `blockChainDate` INTEGER, `date` INTEGER, `isAutosave` INTEGER, PRIMARY KEY(`revHash`));'
    };
